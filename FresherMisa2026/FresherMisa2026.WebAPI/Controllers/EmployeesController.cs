...
namespace FresherMisa2026.WebAPI.Controllers
{
    ...
    public class EmployeesController : BaseController<Employee>
    {
        ...
        {
            var response = new ServiceResponse();
            var paging = await _employeeService.GetEmployeesByFilterAsync(departmentId, positionId, salaryFrom, salaryTo, gender, hireDateFrom, hireDateTo, pageSize, pageIndex);
