...
namespace FresherMisa2026.Application.Services
{
    ...
    public class BaseService<TEntity> : IBaseService<TEntity> where TEntity : BaseModel
    {
        ...
        /// <summary>
        /// Validate tùy chỉnh từng màn hình (hỗ trợ async)
        /// </summary>
        /// <param name="entity">Thực thể</param>
        /// <returns>Danh sách lỗi tùy chỉnh</returns>
        protected virtual Task<List<ValidationError>> ValidateCustomAsync(TEntity entity)
        {
            return Task.FromResult(ValidateCustom(entity));
        }
        ...
        public async Task<ServiceResponse> UpdateAsync(Guid entityId, TEntity entity)
        {
            ...
            //2. Đồng bộ key từ route vào entity để validate custom có thể phân biệt Update với Insert.
            ...
            //3. Validate tất cả các trường nếu được gắn thẻ
            var errors = await ValidateAsync(entity);
