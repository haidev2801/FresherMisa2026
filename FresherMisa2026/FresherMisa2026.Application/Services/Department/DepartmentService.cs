...
namespace FresherMisa2026.Application.Services
{
    public class DepartmentService : BaseService<Department>, IDepartmentService
    {
        ...
        {
            // Không cho xóa phòng ban nếu vẫn còn nhân viên thuộc phòng ban đó.
            var employees = await _employeeRepository.GetEmployeesByDepartmentId(entityId);
            bool hasEmployee = employees.Any();
